...
#define MAIN_JSCOLOR            [UIColor redColor]
...
- (void)setSelected:(BOOL)selected {
    ...
    UILabel* label = (UILabel*)[self viewWithTag:800];
    if(label)
    {
        label.textColor = _selected?MAIN_JSCOLOR:MAIN_JSCOLOR;
    }
...
//        UIImage* image = [UIImage imageNamed:@"xuanzhong.png"];
//        CGFloat offset = (CGRectGetWidth(rect) - image.size.width)/2.0;
//        
//        bezierPath = [UIBezierPath bezierPath];
//        
//        // Draw the indicator
//        [bezierPath moveToPoint:CGPointMake(offset, 2.0)];
//        [bezierPath addLineToPoint:CGPointMake(offset + image.size.width, 2.0)];
//        [bezierPath addLineToPoint:CGPointMake(offset + image.size.width, CGRectGetHeight(rect))];
//        [bezierPath addLineToPoint:CGPointMake(offset, CGRectGetHeight(rect))];
...
//        [bezierPath fill];
//        
//        [image drawAtPoint:CGPointMake(offset, 31.0)];
        
        UIColor *color = (UIColor *)MAIN_JSCOLOR;
